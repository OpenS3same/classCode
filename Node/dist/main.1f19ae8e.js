...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // import cube from './modules.js'
...
// 자전거 지도 만들기
var API_KEY = '684253514a68796737364e6543675a';
function getData() {
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          locations = data.rentBikeStatus.row.map(function (spot) {
            return [spot.stationName, spot.stationLatitude, spot.stationLongitude];
          });
          console.log(data);
